...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("it takes 14 chickens to eat 14 chicken nuggets trust me ive tried it"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("6 days ago i saw a tsunami, also i dont know how to spell tsunami, i think, well i wouldnt know if i did or didnt"), False)

        self.assertEqual(pythonBasics3.starts_with_non_number("0 ayo thats a zero"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        self.assertEqual(pythonBasics3.multiple_words(" yo lo say he "), True)

        self.assertEqual(pythonBasics3.multiple_words("ticklefight"), False)

        self.assertEqual(pythonBasics3.multiple_words("That's not 10/10 true"), True)

        self.assertEqual(pythonBasics3.multiple_words(" I Added A Bunch        Of spaces      "), True)

        self.assertEqual(pythonBasics3.multiple_words("ImBuil;tDifferent"), False)
